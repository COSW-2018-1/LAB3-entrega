...
var AppComponent = (function () {
    ...
    AppComponent.prototype.doSearch = function () {
        var _this = this;
        this.userService.busquedaPorEmail(this.searchForm.get('emailSerach').value).subscribe(function (userResponse) {
